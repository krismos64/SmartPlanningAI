...
echo "Tentative de connexion à la base de données MySQL via socket $socket...\n";

try {
    // Utilisation du socket pour la connexion
    $conn = new mysqli($host, $user, $password, '', 3306, $socket);
